...
const SignupPage = () => {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      await signup(data.username, data.email, data.password); // Call the signup function
      ...
      >
        <div className="text-center mb-8">
          ...
          >
            ...
            <Link to="/login" className="font-medium text-primary-500 hover:text-primary-400 transition-colors duration-200">
              Sign in
            </Link>
          </motion.p>
        </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div>
              ...
              <input
                ...
                className={`input-field font-mono ${errors.username ? 'border-error-500 focus:ring-error-500' : ''}`}
                {...register('username', {
            ...
            <div>
              ...
              <input
                ...
                type="password"
                autoComplete="new-password"
                className={`input-field font-mono ${errors.confirmPassword ? 'border-error-500 focus:ring-error-500' : ''}`}
